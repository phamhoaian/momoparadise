...
(function(e) {
    function q(a) { var b = "cubic-bezier(0.250, 0.250, 0.750, 0.750)"; switch (a) {
            case "linear":
                b = "cubic-bezier(0.250, 0.250, 0.750, 0.750)"; break;
            case "swing":
                b = "cubic-bezier(0.250, 0.100, 0.250, 1.000)"; break;
            case "ease":
                b = "cubic-bezier(0.250, 0.100, 0.250, 1.000)"; break;
            case "ease-in":
                b = "cubic-bezier(0.420, 0.000, 1.000, 1.000)"; break;
            case "ease-out":
                b = "cubic-bezier(0.000, 0.000, 0.580, 1.000)"; break;
            case "ease-in-out":
                b = "cubic-bezier(0.420, 0.000, 0.580, 1.000)"; break;
            case "easeInQuad":
                b = "cubic-bezier(0.550, 0.085, 0.680, 0.530)"; break;
            case "easeOutQuad":
                b = "cubic-bezier(0.250, 0.460, 0.450, 0.940)"; break;
            case "easeInOutQuad":
            case "easeInCubic":
                b = "cubic-bezier(0.550, 0.055, 0.675, 0.190)"; break;
            case "easeOutCubic":
                b = "cubic-bezier(0.215, 0.610, 0.355, 1.000)"; break;
            case "easeInOutCubic":
                b = "cubic-bezier(0.645, 0.045, 0.355, 1.000)"; break;
            case "easeInQuart":
                b = "cubic-bezier(0.895, 0.030, 0.685, 0.220)"; break;
            case "easeOutQuart":
                b = "cubic-bezier(0.165, 0.840, 0.440, 1.000)"; break;
            case "easeInOutQuart":
                b = "cubic-bezier(0.770, 0.000, 0.175, 1.000)"; break;
            case "easeInQuint":
                b = "cubic-bezier(0.755, 0.050, 0.855, 0.060)"; break;
            case "easeOutQuint":
                b = "cubic-bezier(0.230, 1.000, 0.320, 1.000)"; break;
            case "easeInOutQuint":
                b = "cubic-bezier(0.860, 0.000, 0.070, 1.000)"; break;
            case "easeInSine":
                b = "cubic-bezier(0.470, 0.000, 0.745, 0.715)"; break;
            case "easeOutSine":
                b = "cubic-bezier(0.390, 0.575, 0.565, 1.000)"; break;
            case "easeInOutSine":
                b = "cubic-bezier(0.445, 0.050, 0.550, 0.950)"; break;
            case "easeInExpo":
                b = "cubic-bezier(0.950, 0.050, 0.795, 0.035)"; break;
            case "easeOutExpo":
                b = "cubic-bezier(0.190, 1.000, 0.220, 1.000)"; break;
            case "easeInOutExpo":
                b = "cubic-bezier(1.000, 0.000, 0.000, 1.000)"; break;
            case "easeInCirc":
                b = "cubic-bezier(0.600, 0.040, 0.980, 0.335)"; break;
            case "easeOutCirc":
                b = "cubic-bezier(0.075, 0.820, 0.165, 1.000)"; break;
            case "easeInOutCirc":
                b = "cubic-bezier(0.785, 0.135, 0.150, 0.860)"; break;
            case "easeInBack":
                b = "cubic-bezier(0.600, -0.280, 0.735, 0.045)"; break;
            case "easeOutBack":
                b = "cubic-bezier(0.175, 0.885, 0.320, 1.275)"; break;
            case "easeInOutBack":
                b = "cubic-bezier(0.680, -0.550, 0.265, 1.550)" } return b }

    function R(a, b, c) { var p = E();
        ...
        theIframe = a.find("iframe:first"); if (null != theIframe.width() && c.responsive) { theW = theIframe.width();
            theH = theIframe.height(); if ("" == b.iFrameArr[a.index()] || void 0 == b.iFrameArr[a.index()]) b.iFrameArr[a.index()] = theW + ";" + theH;
            iFrameDimensions = b.iFrameArr[a.index()].split(";");
            theIframe.css({ width: parseInt(iFrameDimensions[0] / (c.origWidth / c.width), 10), height: parseInt(iFrameDimensions[1] / (c.origWidth / c.width), 10) }) } var f, n, m, h, g;
        f = a.attr("data-final-left");
        n = a.attr("data-final-top");
        c.responsive && (f = parseInt(f / (c.origWidth / c.width), 10), n = parseInt(n / (c.origWidth / c.width), 10)); var l = c.defaultEasing; "" != a.attr("data-easing") && void 0 != a.attr("data-easing") && (l = a.attr("data-easing"));
        m = 1;!0 == b.isVideoPlaying && (m = 0);
        cur_skew = "0deg,0deg";
        void 0 != a.attr("data-final-skew") && "" != a.attr("data-final-skew") && (cur_skew = a.attr("data-final-skew"));
        cur_scale = "1";
        void 0 != a.attr("data-final-scale") && "" != a.attr("data-final-scale") && (cur_scale = a.attr("data-final-scale")); - 1 != p && 10 > p ? (a.stop().animate({ opacity: m, left: f + "px", top: n + "px" }, 1E3 * a.attr("data-duration"), l, function() { a.css({ "-webkit-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-moz-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-ms-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-o-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", transform: "skew(" + cur_skew + ") scale(" + cur_scale + ")" });!0 == b.isVideoPlaying && e(b.currentImg.attr("data-text-id")).children().css("opacity", 0);
            void 0 != a.attr("data-intermediate-left") && "" != a.attr("data-intermediate-left") && (h = a.attr("data-intermediate-left"), g = a.attr("data-intermediate-top"), c.responsive && (h = parseInt(h / (c.origWidth / c.width), 10), g = parseInt(g / (c.origWidth / c.width), 10)), b.timeouts_arr[b.timeouts_arr.length] = setTimeout(function() { cur_skew = "0deg,0deg";
    ...
    function K(a, b, c, p, f, n, m) { var h = E();
        ...
        b.each(function() { currentText_arr[r] = e(this); var b = currentText_arr[r];
            ...
            cur_scale = "1";
            void 0 != b.attr("data-initial-scale") && "" != b.attr("data-initial-scale") && (cur_scale = b.attr("data-initial-scale")); - 1 != h && 10 > h ? (b.css({ opacity: parseFloat(b.attr("data-fade-start")) / 100, left: g + "px", top: l + "px", "-webkit-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-moz-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-ms-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-o-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", transform: "skew(" + cur_skew + ") scale(" + cur_scale + ")" }), 8 == h && b.find("img:first").is("img") && b.find("img:first").css("opacity", parseFloat(b.attr("data-fade-start")) / 100)) : b.css({ opacity: parseFloat(b.attr("data-fade-start")) / 100, "-webkit-transform": "translate(" + g + "px," + l + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-moz-transform": "translate(" + g + "px," + l + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-ms-transform": "translate(" + g + "px," + l + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-o-transform": "translate(" + g + "px," + l + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", transform: "translate(" + g + "px," + l + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-webkit-transition-duration": "0s", "-moz-transition-duration": "0s", "-ms-transition-duration": "0s", "-o-transition-duration": "0s", "transition-duration": "0s" });
            m || (a.timeouts_arr[a.timeouts_arr.length] = setTimeout(function() { R(b, a, c) }, 1E3 * b.attr("data-delay")));
            r++ }) }

    function Z(a, b, c, p) { var f = E();
        c = e(a.currentImg.attr("data-text-id")).children(); var n = 0;
        currentText_arr = [];
        c.each(function() { currentText_arr[n] = e(this); var c = currentText_arr[n],
                h = b.defaultExitLeft;
            void 0 != c.attr("data-exit-left") && "" != c.attr("data-exit-left") && (h = parseInt(c.attr("data-exit-left") / (b.origWidth / b.width), 10)); var g = b.defaultExitTop;
            void 0 != c.attr("data-exit-top") && "" != c.attr("data-exit-top") && (g = parseInt(c.attr("data-exit-top") / (b.origWidth / b.width), 10)); var l = b.defaultExitDuration;
            void 0 != c.attr("data-exit-duration") && "" != c.attr("data-exit-duration") && (l = parseFloat(c.attr("data-exit-duration"))); var p = b.defaultExitDelay;
            void 0 != c.attr("data-exit-delay") && "" != c.attr("data-exit-delay") && (p = parseFloat(c.attr("data-exit-delay"))); var t = b.defaultExitFade;
            void 0 != c.attr("data-exit-fade") && "" != c.attr("data-exit-fade") && (t = parseFloat(c.attr("data-exit-fade")));
            void 0 != c.attr("data-exit-easing") && "" != c.attr("data-exit-easing") && c.attr("data-exit-easing"); var s = b.defaultExitOFF.toString();
            void 0 != c.attr("data-exit-off") && "" != c.attr("data-exit-off") && (s = c.attr("data-exit-off"));
            b.fadeSlides && (s = "false"); "true" == s && (l = 0); var G = b.defaultExitEasing; "" != c.attr("data-exit-easing") && void 0 != c.attr("data-exit-easing") && (G = c.attr("data-exit-easing"));
            theIframe = c.find("iframe:first");
            null != theIframe.width() && (theIframe[0].src = theIframe[0].src);
            0 < l ? a.timeouts_arr[a.timeouts_arr.length] = setTimeout(function() { cur_skew = "0deg,0deg";
                void 0 != c.attr("data-exit-skew") && "" != c.attr("data-exit-skew") && (cur_skew = c.attr("data-exit-skew"));
                cur_scale = "1";
                void 0 != c.attr("data-exit-scale") && "" != c.attr("data-exit-scale") && (cur_scale = c.attr("data-exit-scale")); - 1 != f && 10 > f ? (c.stop().animate({ opacity: t, left: h + "px", top: g + "px" }, 1E3 * l, G, function() { c.css({ "-webkit-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-moz-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-ms-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", "-o-transform": "skew(" + cur_skew + ") scale(" + cur_scale + ")", transform: "skew(" + cur_skew + ") scale(" + cur_scale + ")" }) }), 8 == f && c.find("img:first").is("img") && c.find("img:first").animate({ opacity: t }, 1E3 * l, G, function() {})) : c.css({ opacity: t, "-webkit-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-moz-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-ms-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-o-transform": "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", transform: "translate(" + h + "px," + g + "px) skew(" + cur_skew + ") scale(" + cur_scale + ")", "-webkit-transition-duration": l + "s", "-moz-transition-duration": l + "s", "-ms-transition-duration": l + "s", "-o-transition-duration": l + "s", "transition-duration": l + "s", "-webkit-transition-timing-function": q(G), "-moz-transition-timing-function": q(G), "-ms-transition-timing-function": q(G), "-o-transition-timing-function": q(G), "transition-timing-function": q(G) }) }, 1E3 * p) : "false" == s && c.css({ display: "none" });
            n++ }) }
    ...
    function M(a, b, c, p, f) { var n = E(); - 1 == a && (a = 0); var m = e(f[a]);
        f = b.horizontalPosition;
        void 0 != m.attr("data-horizontalPosition") && "" != m.attr("data-horizontalPosition") && (f = m.attr("data-horizontalPosition")); var h = b.verticalPosition;
        void 0 != m.attr("data-verticalPosition") && "" != m.attr("data-verticalPosition") && (h = m.attr("data-verticalPosition")); var g = b.initialZoom;
        void 0 != m.attr("data-initialZoom") && "" != m.attr("data-initialZoom") && (g = Number(m.attr("data-initialZoom"))); var l = b.finalZoom;
        ...
        c = 0; switch (f) {
            case "left":
                c = 0; break;
            case "center":
                c = (b.width - parseInt(g * p[0], 10)) / 2; break;
            case "right":
                c = b.width - parseInt(g * p[0], 10); break;
            default:
                c = 0 } l = 0; switch (h) {
            case "top":
                l = -2; break;
            case "center":
                l = (b.height - parseInt(g * p[1], 10)) / 2; break;
            case "bottom":
                l = b.height - parseInt(g * p[1], 10) + 2; break;
            default:
                l = 0 } a.css({ left: parseInt(c, 10) + "px", top: parseInt(l, 10) + "px", opacity: b.initialOpacity });
    ...
    function S(a, b, c, p, f) { f = e(f[a.current_img_no]); var n = E(),
            m = b.horizontalPosition;
        void 0 != f.attr("data-horizontalPosition") && "" != f.attr("data-horizontalPosition") && (m = f.attr("data-horizontalPosition")); var h = b.verticalPosition;
        void 0 != f.attr("data-verticalPosition") && "" != f.attr("data-verticalPosition") && (h = f.attr("data-verticalPosition")); var g = b.duration;
        void 0 != f.attr("data-duration") && "" != f.attr("data-duration") && (g = Number(f.attr("data-duration"))); var l = b.initialZoom;
        void 0 != f.attr("data-initialZoom") && "" != f.attr("data-initialZoom") && (l = Number(f.attr("data-initialZoom"))); var r = b.finalZoom;
        ...
        a.previous_imgInside = e("#contentHolderUnit_" + a.previous_current_img_no, c).find("img:first"); var t = p[a.current_img_no].split(";");
        b.responsive && (t[0] /= b.origWidth / b.width, t[1] /= b.origWidth / b.width);
        l != r ? -1 != n && 10 > n ? (b.width100Proc && (g += b.durationIEfix), a.curZoom = 1, zoomStep = 0, a.cur_marginLeft = 0, a.cur_marginTop = 0, -1 != n && 10 > n && clearInterval(a.msiInterval), a.msiInitialTime = (new Date).getTime(), a.msiInterval = setInterval(function() { nowx = (new Date).getTime();
    ...
    function J(a, b, c, p, f, n, m, h, g, l, r, t, s, q, w, u) { var v = E(),
        ...
        y && !b.slideIsRunning && b.firstLoadingComplete && (b.slideIsRunning = !0, H(b.timeouts_arr), L(b.continuouseIntervalIDs), $(b.rotationFunctionsArr, b), Z(b, c, n, m), b.arcInitialTime = (new Date).getTime(), b.timeElapsed = 0, c.showCircleTimer && (clearInterval(b.intervalID), b.ctx.clearRect(0, 0, b.canvas.width, b.canvas.height), b.ctx.beginPath(), b.ctx.globalAlpha = c.behindCircleAlpha / 100, b.ctx.arc(c.circleRadius + 2 * c.circleLineWidth, c.circleRadius + 2 * c.circleLineWidth, c.circleRadius, 0, 2 * Math.PI, !1), b.ctx.lineWidth = c.circleLineWidth + 2, b.ctx.strokeStyle = c.behindCircleColor, b.ctx.stroke(), b.ctx.beginPath(), b.ctx.globalAlpha = c.circleAlpha / 100, b.ctx.arc(c.circleRadius + 2 * c.circleLineWidth, c.circleRadius + 2 * c.circleLineWidth, c.circleRadius, 0, 0, !1), b.ctx.lineWidth = c.circleLineWidth, b.ctx.strokeStyle = c.circleColor, b.ctx.stroke(), b.intervalID = setInterval(function() { W(b, c) }, 125)), b.bottomNavClicked || (b.previous_current_img_no = b.current_img_no), b.bottomNavClicked = !1, "opportune" == c.skin && e(p[b.current_img_no]).removeClass("bottomNavButtonON"), "opportune" != c.skin && e(t[b.current_img_no]).removeClass("thumbsHolder_ThumbON"), l.css("display", "none"), b.current_img_no = b.current_img_no + a >= b.total_images ? 0 : 0 > b.current_img_no + a ? b.total_images - 1 : b.current_img_no + a, X(f, b, c), "opportune" == c.skin && e(p[b.current_img_no]).addClass("bottomNavButtonON"), "opportune" != c.skin && (e(t[b.current_img_no]).addClass("thumbsHolder_ThumbON"), currentCarouselLeft = s.css("left").substr(0, s.css("left").lastIndexOf("px")), 0 === b.current_img_no || b.current_img_no === b.total_images - 1 ? P(0, s, q, w, c, u, b) : P(1001, s, q, w, c, u, b)), setTimeout(function() { b.currentImg = e(f[b.current_img_no]);
            S(b, c, g, r, f) }, 100), c.fadeSlides ? (e("#contentHolderUnit_" + b.current_img_no, g).css({ opacity: 1, "z-index": 0, display: "block" }), e("#contentHolderUnit_" + b.previous_current_img_no, g).css({ "z-index": 1, display: "block" }), e("#contentHolderUnit_" + b.previous_current_img_no, g).animate({ opacity: 0 }, 1E3 * c.scrollSlideDuration, c.scrollSlideEasing, function() { b.slideIsRunning = !1;
            c.fadeSlides && (e("#contentHolderUnit_" + b.current_img_no, g).css({ "z-index": 1 }), e("#contentHolderUnit_" + b.previous_current_img_no, g).css({ "z-index": 0, display: "none" })); "true" == b.currentImg.attr("data-video") && l.css("display", "block");
            ...
            K(b, b.currentImg, c, n, g, m, !1); - 1 != v && 10 > v && b.previous_imgInside.css("filter", 'progid:DXImageTransform.Microsoft.Matrix(FilterType="bilinear",M11=1, M12=0, M21=0, M22=1, Dx=0, Dy=0)') })) : h.animate({ left: -1 * b.current_img_no * c.width + "px" }, 1E3 * c.scrollSlideDuration, c.scrollSlideEasing, function() { b.slideIsRunning = !1; "true" == b.currentImg.attr("data-video") && l.css("display", "block");
            e("#contentHolderUnit_" + b.previous_current_img_no, g).html(e(f[b.previous_current_img_no]).html());
            M(b.previous_current_img_no, c, g, b.origImgsDimensions, f);
            H(b.timeouts_arr);
            K(b, e(f[b.previous_current_img_no]), c, n, g, m, !0);
            K(b, b.currentImg, c, n, g, m, !1); - 1 != v && 10 > v && b.previous_imgInside.css("filter", 'progid:DXImageTransform.Microsoft.Matrix(FilterType="bilinear",M11=1, M12=0, M21=0, M22=1, Dx=0, Dy=0)') }), 0 < b.autoPlay && 1 < b.total_images && !b.mouseOverBanner && (b.timeoutID = setTimeout(function() { J(1, b, c, p, f, n, m, h, g, l, r, t, s, q, w, u) }, 1E3 * b.autoPlay))) }

    function Q(a, b, c, e, f) { b = c.origImgsDimensions[b].split(";");
    ...
    function aa(a, b, c, p, f, n, m) { c.responsive && (imgInside = e("#contentHolderUnit_" + a, f).find("img:first"), null != imgInside.width() && Q(imgInside, a, b, c, !0), textIdChildren = e(e(p[a]).attr("data-text-id")).children(), k = -1, textIdChildren.each(function() { k++;
            imgInside = e(this).find("img:first");
            null != imgInside.width() && Q(imgInside, e(p[a]).attr("data-text-id") + "-" + k, b, c, !1) }), e(e(p[a]).attr("data-text-id")).css({ width: c.width + "px", left: parseInt(a * c.width, 10), top: m.css("top") })) }

    function P(a, b, c, e, f, n, m) { currentCarouselLeft = b.css("left").substr(0, b.css("left").lastIndexOf("px"));
        1 === a || -1 === a ? (m.isCarouselScrolling = !0, b.css("opacity", "0.5"), b.animate({ opacity: 1, left: "+=" + a * m.carouselStep }, 500, "easeOutCubic", function() { N(m, b, c, e, f, n);
            m.isCarouselScrolling = !1 })) : currentCarouselLeft != -1 * Math.floor(m.current_img_no / f.numberOfThumbsPerScreen) * m.carouselStep && (m.isCarouselScrolling = !0, b.css("opacity", "0.5"), b.animate({ opacity: 1, left: -1 * Math.floor(m.current_img_no / f.numberOfThumbsPerScreen) * m.carouselStep }, 500, "easeOutCubic", function() { N(m, b, c, e, f, n);
            m.isCarouselScrolling = !1 })) }

    function N(a, b, c, e, f, n) { currentCarouselLeft = b.css("left").substr(0, b.css("left").lastIndexOf("px"));
    ...
    function Y(a, b, c, p, f, n, m, h, g, l) { "opportune" != b.skin && (l.css({ top: b.height + "px", "margin-top": parseInt(b.thumbsWrapperMarginTop / (b.origWidth / b.width), 10) + "px", height: parseInt(b.origthumbsHolderWrapperH / (b.origWidth / b.width), 10) + "px" }), bgTopCorrection = 0, n.css("background-position", "0px " + ((l.height() - b.origthumbsHolderWrapperH) / 2 + bgTopCorrection) + "px"), m.css("background-position", "0px " + ((l.height() - b.origthumbsHolderWrapperH) / 2 + bgTopCorrection) + "px"), g.css("width", b.width - n.width() - m.width()), b.origWidthThumbsHolderVisibleWrapper = b.origWidth - n.width() - m.width(), p.css({ width: parseInt(b.origThumbW / (b.origWidthThumbsHolderVisibleWrapper / g.width()), 10) + "px", height: parseInt(b.origThumbH / (b.origWidthThumbsHolderVisibleWrapper / g.width()), 10) + "px" }), b.numberOfThumbsPerScreen >= a.total_images && g.css("left", parseInt((l.width() - (h.width() + a.thumbMarginLeft) * a.total_images) / 2, 10) + "px"), e(".thumbsHolder_ThumbOFF", c).find("img:first").css({ width: p.width() + "px", height: p.height() + "px", "margin-top": parseInt((l.height() - p.height()) / 2, 10) + "px" }), a.thumbMarginLeft = Math.floor((l.width() - n.width() - m.width() - h.width() * b.numberOfThumbsPerScreen) / (b.numberOfThumbsPerScreen - 1)), thumb_i = -1, f.children().each(function() { thumb_i++;
            theThumb = e(this);
            theThumb.css("background-position", "center " + b.thumbsOnMarginTop / (b.origWidth / b.width) + "px");
            0 >= thumb_i ? theThumb.css("margin-left", Math.floor((l.width() - n.width() - m.width() - (a.thumbMarginLeft + theThumb.width()) * (b.numberOfThumbsPerScreen - 1) - theThumb.width()) / 2) + "px") : theThumb.css("margin-left", a.thumbMarginLeft + "px") }), a.carouselStep = (h.width() + a.thumbMarginLeft) * b.numberOfThumbsPerScreen) }

    function ba(a, b, c, p, f, n, m, h, g, l, r, t, s, q, w, u, v, y, d, D, E, z) { e(".bannerscollection_zoominout_texts", h).css({ display: "none" });
        b.fadeSlides && e("#contentHolderUnit_" + a.current_img_no, h).css({ "z-index": 0, display: "none" }); if (b.width100Proc && b.height100Proc && !b.setAsBg) { var I = e("body").css("overflow");
            e("body").css("overflow", "hidden") } t = 0;
        ...
        b.height100Proc && (b.height = responsiveHeight); if (b.origWidth != responsiveWidth || b.width100Proc) { b.origWidth > responsiveWidth || b.width100Proc ? b.width = responsiveWidth : b.width100Proc || (b.width = b.origWidth);
            ...
            m.width(b.width);
            m.height(b.height);
            f.css("margin-top", parseInt((b.height - v.height()) / 2, 10) + "px"); for (i = 0; i < a.total_images; i++) aa(i, a, b, c, h, p, f);
            ...
            holderWidth = b.width * a.total_images; for (i = 0; i < a.total_images; i++) M(i, b, h, a.origImgsDimensions, c), t = b.fadeSlides ? 0 : parseInt(i * b.width, 10), e(e(c[i]).attr("data-text-id")).css({ width: p.width() + "px", left: t, top: f.css("top") });
            m.width(holderWidth); "opportune" == b.skin ? (d.css({ left: parseInt((h.width() - d.width()) / 2, 10) + "px", top: b.height + "px" }), b.width100Proc && b.height100Proc || d.css("margin-top", parseInt(b.thumbsWrapperMarginTop / (b.origWidth / b.width), 10) + "px")) : Y(a, b, h, r, s, q, w, u, D, E);
            g.css({ left: parseInt((b.width - g.width()) / 2, 10) + "px", top: parseInt((b.height - g.height()) / 2, 10) + "px" });
            clearTimeout(a.timeoutID);
            L(a.continuouseIntervalIDs);
            1 < a.total_images ? z.click() : (e("#contentHolderUnit_" + a.current_img_no, h).html(e(c[a.previous_current_img_no]).html()), M(a.current_img_no, b, h, a.origImgsDimensions, c), H(a.timeouts_arr), e(".newFS", h).contents().unwrap(), K(a, a.currentImg, b, p, h, f, !1), b.fadeSlides && e("#contentHolderUnit_" + a.current_img_no, h).css({ opacity: 1, "z-index": 0, display: "block" }), setTimeout(function() { S(a, b, h, l, c) }, 100)) } b.width100Proc && b.height100Proc && !b.setAsBg && e("body").css("overflow", I) }

    function E() { var a = -1; if ("Microsoft Internet Explorer" == navigator.appName) { var b = navigator.userAgent,
                c = /MSIE ([0-9]{1,}[.0-9]{0,})/;
            null != c.exec(b) && (a = parseFloat(RegExp.$1)) } else "Netscape" == navigator.appName && (b = navigator.userAgent, c = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/, null != c.exec(b) && (a = parseFloat(RegExp.$1))); return parseInt(a, 10) }

    function X(a, b, c) { b.autoPlay = c.autoPlay;
        void 0 != e(a[b.current_img_no]).attr("data-autoPlay") && "" != e(a[b.current_img_no]).attr("data-autoPlay") && (b.autoPlay = e(a[b.current_img_no]).attr("data-autoPlay")) } e.fn.bannerscollection_zoominout = function(a) { a = e.extend({}, e.fn.bannerscollection_zoominout.defaults, a); return this.each(function() { var b = e(this);
            ...
            a.responsive && (a.origWidth != responsiveWidth || a.width100Proc) && (a.width = a.origWidth > responsiveWidth || a.width100Proc ? responsiveWidth : a.origWidth, a.height100Proc || (a.height = a.width / (a.origWidth / a.origHeight))); var c = e("<div></div>").addClass("bannerscollection_zoominout").addClass(a.skin),
            ...
            b.wrap(c);
            b.after(p); var f = b.parent(".bannerscollection_zoominout");
            a.setAsBg && f.wrap('<div class="setAsBg" />'); var n = e(".bannerControls", f),
                m = e(".contentHolderVisibleWrapper", f),
                h = e(".contentHolder", f),
                c = e('<div class="bottomNav"></div>');
            b.after(c);
            a.showAllControllers || n.css("display", "none"); var g = e(".leftNav", f),
                l = e(".rightNav", f);
            g.css("display", "none");
            l.css("display", "none");
            a.showNavArrows && a.showOnInitNavArrows && (g.css("display", "block"), l.css("display", "block")); var r = e(".bottomNav", f),
                t; "opportune" == a.skin && (r.css({ display: "block", top: a.height + "px" }), a.width100Proc && a.height100Proc ? r.css("margin-top", a.thumbsWrapperMarginTop + "px") : r.css("margin-top", a.thumbsWrapperMarginTop / (a.origWidth / a.width) + "px"));
            a.showBottomNav || r.css("display", "none");
            a.showOnInitBottomNav || r.css("left", "-5000px"); var s = e(".thumbsHolderWrapper", f),
            ...
            a.showBottomNav && a.showOnInitBottomNav || s.css({ opacity: 0, display: "none" }); "opportune" != a.skin && s.css("margin-top", parseInt(a.thumbsWrapperMarginTop / (a.origWidth / a.width), 10) + "px");
            c = E();
            a.enableTouchScreen && (a.fadeSlides && (p = Math.floor(1E5 * Math.random()), f.wrap('<div id="zoominoutParent_' + p + '" style="position:relative;" />'), e("#zoominoutParent_" + p).width(a.width + 1), e("#zoominoutParent_" + p).height(a.height)), -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || (h.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move"), f.css("cursor", "url(" + a.absUrl + "skins/hand.cur),url(" + a.absUrl + "skins/hand.cur),move")), h.css("left", "0"), a.fadeSlides ? -1 != c && 9 == c && a.fadeSlides && "opportune" == a.skin || f.draggable({ axis: "x", containment: "parent", distance: 10, start: function(a, b) { origLeft = parseInt(e(this).css("left"), 10);
                    y.css("display", "none") }, stop: function(a, b) { d.slideIsRunning || (finalLeft = parseInt(e(this).css("left"), 10), origLeft < finalLeft ? g.click() : l.click(), e(this).css("left", "0px")) } }) : h.draggable({ axis: "x", distance: 10, disabled: !0, start: function(a, b) { origLeft = parseInt(e(this).css("left"), 10);
                    y.css("display", "none") }, stop: function(a, b) { d.slideIsRunning || (finalLeft = parseInt(e(this).css("left"), 10), origLeft < finalLeft ? g.click() : l.click()) } })); var y = e(".playOver", f);
            y.css({ left: parseInt((a.width - y.width()) / 2, 10) + "px", top: parseInt((a.height - y.height()) / 2, 10) + "px" }); var d = { total_images: 0, current_img_no: 0, currentImg: 0, previous_current_img_no: 0, autoPlay: !1, slideIsRunning: !1, mouseOverBanner: !1, isVideoPlaying: !1, bottomNavClicked: !1, current_imgInside: "", previous_imgInside: "", windowWidth: 0, carouselStep: 0, thumbMarginLeft: 0, timeoutID: "", intervalID: "", arcInitialTime: (new Date).getTime(), timeElapsed: 0, origImgsDimensionsBGS: [], origImgsDimensions: [], canvas: "", ctx: "", timeouts_arr: [], continuouseIntervalIDs: [], rotationFunctionsArr: [], rotationDurationArr: [], iFrameArr: [], bannerRatio: a.origWidth / a.origHeight, msiInterval: "", msiInitialTime: (new Date).getTime(), curZoom: 0, cur_marginLeft: 0, cur_marginTop: 0, firstLoadingComplete: !1 };
            ...
            a.showCircleTimer && (d.ctx = d.canvas.getContext("2d")); var D = [],
                H = 0;
            f.width(a.width);
            f.height(a.height);
            m.width(a.width);
            ...
            c = b.find("ul:first");
            d.total_images = 0; var z = c.children(),
                I, T = 0,
                F, O = 0,
                L = 0,
                A, x, U = 0,
            ...
            z.each(function() { d.currentImg = e(this);
                d.currentImg.is("li") || (d.currentImg = d.currentImg.find("li:first")); if (d.currentImg.is("li")) { d.total_images++;
                    myzindex = 0;
                    mydisplay = "none";
            ...
            f.mouseleave(function() { a.pauseOnMouseOver && 1 < d.total_images && d.firstLoadingComplete && (d.mouseOverBanner = !1, nowx = (new Date).getTime());
                a.autoHideNavArrows && a.showNavArrows && !d.isVideoPlaying && (g.css("display", "none"), l.css("display", "none"));
                a.autoHideBottomNav && a.showBottomNav && ("opportune" == a.skin ? r.css("display", "none") : s.stop().animate({ opacity: 0 }, 300, "swing", function() {})); if (0 < d.autoPlay && 1 < d.total_images && !d.isVideoPlaying && a.pauseOnMouseOver && d.firstLoadingComplete) { clearTimeout(d.timeoutID);
                    d.arcInitialTime = (new Date).getTime(); var c = parseInt(1E3 * d.autoPlay - (d.timeElapsed + nowx - d.arcInitialTime), 10);
                    d.timeoutID = setTimeout(function() { J(1, d, a, C, z, b, n, h, f, y, D, B, w, u, v, x) }, c) } });
            ...
            y.click(function() { y.css("display", "none");
            ...
            g.click(function() { d.slideIsRunning || (d.isVideoPlaying = !1, a.showBottomNav && (s.css({ opacity: 1, display: "block" }), "opportune" == a.skin && r.css("display", "block")), clearTimeout(d.timeoutID), J(-1, d, a, C, z, b, n, h, f, y, D, B, w, u, v, x)) });
            l.click(function() { d.slideIsRunning || (d.isVideoPlaying = !1, a.showBottomNav && (s.css({ opacity: 1, display: "block" }), "opportune" == a.skin && r.css("display", "block")), clearTimeout(d.timeoutID), J(1, d, a, C, z, b, n, h, f, y, D, B, w, u, v, x)) }); var V = !1;
            e(window).resize(function() { var c = E();
                ...
                a.responsive && doResizeNow && !d.slideIsRunning && (!1 !== V && clearTimeout(V), V = setTimeout(function() { ba(d, a, z, b, n, m, h, f, y, D, B, C, w, u, v, x, g, F, r, q, s, l) }, 300)) }); var C = e(".bottomNavButtonOFF", f); "opportune" == a.skin && (C.click(function() { if (!d.slideIsRunning && d.firstLoadingComplete) { d.isVideoPlaying = !1; var c = e(this).attr("rel");
                    d.current_img_no != c && (e(C[d.current_img_no]).removeClass("bottomNavButtonON"), d.previous_current_img_no = d.current_img_no, d.bottomNavClicked = !0, d.current_img_no = c - 1, clearTimeout(d.timeoutID), J(1, d, a, C, z, b, n, h, f, y, D, B, w, u, v, x)) } }), C.mouseenter(function() { var b = e(this),
                    c = b.attr("rel"); if (a.showPreviewThumbs) { t = e('<div class="bottomOverThumb"></div>');
                    b.append(t); var d = e(z[c]).attr("data-bottom-thumb"),
                    ...
                    e("#newThumb").stop().animate({ marginLeft: "0px" }, 150, function() { t.html('<div class="innerBottomOverThumb"><img src="' + d + '"></div>') });
                    e("#oldThumb").stop().animate({ marginLeft: h + "px" }, 150, function() {});
                    H = c } b.addClass("bottomNavButtonON") }), C.mouseleave(function() { var b = e(this),
                    c = b.attr("rel");
                a.showPreviewThumbs && t.remove();
                d.current_img_no != c && b.removeClass("bottomNavButtonON") }));
            B.mousedown(function() { if (!d.slideIsRunning && d.firstLoadingComplete) { arrowClicked = !0;
                    d.isVideoPlaying = !1; var c = e(this).attr("rel");
            ...
            B.mouseup(function() { arrowClicked = !1 });
            B.mouseenter(function() { var a = e(this);
                a.attr("rel");
                a.addClass("thumbsHolder_ThumbON") });
            B.mouseleave(function() { var a = e(this),
                    b = a.attr("rel");
                d.current_img_no != b && a.removeClass("thumbsHolder_ThumbON") });
            u.click(function() { d.isCarouselScrolling || (currentCarouselLeft = w.css("left").substr(0, w.css("left").lastIndexOf("px")), 0 > currentCarouselLeft && P(1, w, u, v, a, x, d)) });
            v.click(function() { d.isCarouselScrolling || (currentCarouselLeft = w.css("left").substr(0, w.css("left").lastIndexOf("px")), Math.abs(currentCarouselLeft - d.carouselStep) < (x.width() + d.thumbMarginLeft) * d.total_images && P(-1, w, u, v, a, x, d)) }); "opportune" == a.skin && e(C[d.current_img_no]).addClass("bottomNavButtonON");
            e(B[d.current_img_no]).addClass("thumbsHolder_ThumbON");
            X(z, d, a);
            setTimeout(function() { e(".myloader", f).css("display", "none");
                ...
                0 < d.autoPlay && 1 < d.total_images && (clearTimeout(d.timeoutID), a.showCircleTimer && (d.intervalID = setInterval(function() { W(d, a) }, 125)), d.timeoutID = setTimeout(function() { J(1, d, a, C, z, b, n, h, f, y, D, B, w, u, v, x) }, 1E3 * d.autoPlay)) }, 1E3 * a.myloaderTime); "true" == e(z[d.current_img_no]).attr("data-video") && y.css("display", "block") }) };
